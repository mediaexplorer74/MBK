    ...
    private bool AddXAxis(DateTime dtStart, DateTime dtEnd)
    {
      ...
      if (num > 0)
      {
        ...
        if (num > 15)
        {
          ...
          ((FrameworkElement) textBlock1).put_Margin(new Thickness(0.0, 0.0, -4.0, 0.0));
        ...
        border1.put_BorderThickness(new Thickness(0.0, 0.0, 1.0, 0.0));
        ...
        border2.put_BorderBrush((Brush) solidColorBrush);
        ((FrameworkElement) border1).put_HorizontalAlignment((HorizontalAlignment) 3);
        ((FrameworkElement) border1).put_VerticalAlignment((VerticalAlignment) 3);
        ((FrameworkElement) border1).put_Margin(new Thickness(0.0, 0.0, 0.0, 23.0));
      ...
      do
      {
        ...
        if (localTime.Hour != 23)
        {
          ...
          {
            localTime = dateTime.ToLocalTime();
            str = localTime.ToString("hh", (IFormatProvider) this.sleepPageCultureInfo).TrimStart('0');
            goto label_11;
          }
        }
        localTime = dateTime.ToLocalTime();
...
label_11:
        ...
        color.G = (byte) 145;
        color.B = (byte) 145;
        textBlock3.put_Foreground((Brush) new SolidColorBrush(color));
        ((FrameworkElement) textBlock3).put_Margin(new Thickness(0.0, 0.0, -4.0, 0.0));
        ...
        border3.put_BorderThickness(new Thickness(0.0, 0.0, 1.0, 0.0));
        ...
        color.B = (byte) 234;
        SolidColorBrush solidColorBrush = new SolidColorBrush(color);
        border4.put_BorderBrush((Brush) solidColorBrush);
        ((FrameworkElement) border3).put_HorizontalAlignment((HorizontalAlignment) 3);
        ((FrameworkElement) border3).put_VerticalAlignment((VerticalAlignment) 3);
        ((FrameworkElement) border3).put_Margin(new Thickness(0.0, 0.0, 0.0, 23.0));
    ...
    private bool AddBar(SleepPage.SleepType sleepType, TimeSpan tsLength)
    {
      ...
      Grid.SetColumn((FrameworkElement) rectangle, ((ICollection<ColumnDefinition>) this.BarPanel.ColumnDefinitions).Count - 1);
      ((ICollection<UIElement>) ((Panel) this.BarPanel).Children).Add((UIElement) rectangle);
      return flag;
    }

    private bool AddAwakeBar(TimeSpan dtLength) => this.AddBar(SleepPage.SleepType.Awake, dtLength);

    private bool AddLightBar(TimeSpan dtLength) => this.AddBar(SleepPage.SleepType.LightSleep, dtLength);

    private bool AddRestfulBar(TimeSpan dtLength) => this.AddBar(SleepPage.SleepType.RestfulSleep, dtLength);
    ...
    private async void WorkoutTracks_Loaded(object sender, TracksLoadedEventArgs e)
    {
      ...
      try
      {
        ...
        await ((DependencyObject) this).Dispatcher.RunAsync((CoreDispatcherPriority) 1, new DispatchedHandler((object) this, __methodptr(\u003CWorkoutTracks_Loaded\u003Eb__59_0)));
      }
      catch (Exception ex)
      {
      }
    ...
    public async Task ShowChart(double width, double height, WorkoutItem workout) => await ((DependencyObject) this).Dispatcher.RunAsync((CoreDispatcherPriority) 0, new DispatchedHandler((object) new SleepPage.\u003C\u003Ec__DisplayClass61_0()
    {
      \u003C\u003E4__this = this,
      height = height,
      width = width,
    ...
    private async void SleepDiagrams_SizeChanged(object sender, SizeChangedEventArgs e)
    {
      ...
      if (!(e.PreviousSize != e.NewSize))
        return;
      WorkoutItem workout = sender is Canvas canvas ? ((FrameworkElement) canvas).DataContext as WorkoutItem : (WorkoutItem) null;
      if (workout == null)
        return;
    ...
    public void InitializeComponent()
    {
      ...
      this.Summary = (TextBlock) ((FrameworkElement) this).FindName("Summary");
      this.Date = (TextBlock) ((FrameworkElement) this).FindName("Date");
      this.LightHours = (TextBlock) ((FrameworkElement) this).FindName("LightHours");
      this.LightMinutes = (TextBlock) ((FrameworkElement) this).FindName("LightMinutes");
      this.RestfulHours = (TextBlock) ((FrameworkElement) this).FindName("RestfulHours");
      this.RestfulMinutes = (TextBlock) ((FrameworkElement) this).FindName("RestfulMinutes");
      this.Hours = (TextBlock) ((FrameworkElement) this).FindName("Hours");
      this.Minutes = (TextBlock) ((FrameworkElement) this).FindName("Minutes");
      this.AsleepTime = (TextBlock) ((FrameworkElement) this).FindName("AsleepTime");
      this.AwakeTime = (TextBlock) ((FrameworkElement) this).FindName("AwakeTime");
      this.XAxis = (Grid) ((FrameworkElement) this).FindName("XAxis");
      this.BarPanel = (Grid) ((FrameworkElement) this).FindName("BarPanel");
      this.SleepDiagrams = (Canvas) ((FrameworkElement) this).FindName("SleepDiagrams");
      this.LineHour = (Grid) ((FrameworkElement) this).FindName("LineHour");
      this.HourText = (Grid) ((FrameworkElement) this).FindName("HourText");
    }
    ...
    public void Connect(int connectionId, object target)
    {
      switch (connectionId)
      {
        ...
        case 2:
          ...
          // ISSUE: method pointer
          WindowsRuntimeMarshal.AddEventHandler<SizeChangedEventHandler>(new Func<SizeChangedEventHandler, EventRegistrationToken>(frameworkElement.add_SizeChanged), new Action<EventRegistrationToken>(frameworkElement.remove_SizeChanged), new SizeChangedEventHandler((object) this, __methodptr(SleepDiagrams_SizeChanged)));
          break;
        case 3:
          UIElement uiElement2 = (UIElement) target;
          // ISSUE: method pointer
          WindowsRuntimeMarshal.AddEventHandler<TappedEventHandler>(new Func<TappedEventHandler, EventRegistrationToken>(uiElement2.add_Tapped), new Action<EventRegistrationToken>(uiElement2.remove_Tapped), new TappedEventHandler((object) this, __methodptr(Left_Tapped)));
          break;
        case 4:
          UIElement uiElement3 = (UIElement) target;
          // ISSUE: method pointer
          WindowsRuntimeMarshal.AddEventHandler<TappedEventHandler>(new Func<TappedEventHandler, EventRegistrationToken>(uiElement3.add_Tapped), new Action<EventRegistrationToken>(uiElement3.remove_Tapped), new TappedEventHandler((object) this, __methodptr(Right_Tapped)));
          break;
      }
      this._contentLoaded = true;
    }
