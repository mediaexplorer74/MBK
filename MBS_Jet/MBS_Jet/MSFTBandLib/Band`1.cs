...
// Type: MobileBandSync.MSFTBandLib.Band`1
...
namespace MobileBandSync.MSFTBandLib
{
  public class Band<T> : BandInterface where T : class, BandSocketInterface
  {
    ...
    public async Task<DateTime> GetDeviceTime() => TimeHelper.DateTimeResponse(await this.Command(CommandEnum.GetDeviceTime, (Func<uint>) null, (Action<ulong, ulong>) null));

    public async Task<Sleep> GetLastSleep() => new Sleep(await this.Command(CommandEnum.GetStatisticsSleep, (Func<uint>) null, (Action<ulong, ulong>) null));

    public async Task<string> GetSerialNumber() => (await this.Command((CommandEnum) DeviceCommands.CargoGetProductSerialNumber, (Func<uint>) null, (Action<ulong, ulong>) null)).GetByteStream().GetString();
      ...
      bool bStoreSensorLog)
    {
      ...
      Band<T>.\u003C\u003Ec__DisplayClass31_0 cDisplayClass310 = new Band<T>.\u003C\u003Ec__DisplayClass31_0();
      ...
      try
      {
        ...
        if (num1 > 0)
        {
          ...
          // ISSUE: reference to a compiler-generated field
          if (cDisplayClass311.metaData == null)
          {
          ...
          else
          {
            try
            {
              ...
              if (cDisplayClass311.CS\u0024\u003C\u003E8__locals1.Progress != null)
              {
                ...
                await CoreApplication.MainView.CoreWindow.Dispatcher.RunAsync((CoreDispatcherPriority) 0, new DispatchedHandler((object) cDisplayClass311, __methodptr(\u003CGetSensorLog\u003Eb__0)));
              }
            }
            catch (Exception ex)
            {
            ...
            // ISSUE: reference to a compiler-generated field
            // ISSUE: reference to a compiler-generated field
            btSensorLog = await this.GetChunkRangeData(cDisplayClass311.metaData, cDisplayClass311.CS\u0024\u003C\u003E8__locals1.Progress);
    ...
    public async Task<int> RemainingDeviceLogDataChunks() => BitConverter.ToInt32((await this.Command((CommandEnum) DeviceCommands.CargoLoggerGetChunkCounts, (Func<uint>) null, (Action<ulong, ulong>) null)).GetByteStream().GetBytes(), 0);
    ...
    public async Task DeviceLogDataFlush()
    {
      try
      {
        ...
        do
        {
          byte[] status1 = (await this.Command((CommandEnum) DeviceCommands.CargoLoggerFlush, BufferSize, (Action<ulong, ulong>) null)).Status;
    ...
    public async Task<BandMetadataRange> GetChunkRangeMetadata(int chunkCount)
    {
      ...
      try
      {
        ...
        metaResult = BandMetadataRange.DeserializeFromBytes((await this.Command((CommandEnum) DeviceCommands.CargoLoggerGetChunkRangeMetadata, BufferSize, array)).GetByteStream().GetBytes());
      }
      catch (Exception ex)
      {
      }
      ...
      Action<ulong, ulong> Progress)
    {
      ...
      try
      {
        ...
        btResult = (await this.Command((CommandEnum) DeviceCommands.CargoLoggerGetChunkRangeData, BufferSize, array, Progress: Progress)).GetAllData();
      }
      catch (Exception ex)
      {
      }
    ...
    public async Task<bool> DeleteChunkRange(BandMetadataRange metaData)
    {
      ...
      {
        Func<uint> BufferSize = (Func<uint>) (() => 12U);
        await this.CommandStore((CommandEnum) DeviceCommands.CargoLoggerDeleteChunkRange, BufferSize, array, 8192U, (Action<ulong, ulong>) null);
      }
      catch (Exception ex)
      {
      }
    ...
    public async Task<BandVersion> GetVersion() => new BandVersion(await this.Command((CommandEnum) DeviceCommands.CargoCoreModuleGetVersion, (Func<uint>) null, (Action<ulong, ulong>) null));

    public DataReader GetDataReader() => !(this.Connection is BandConnection<BandSocketUWP> connection) ? (DataReader) null : connection.Cargo.GetDataReader();

    public DataWriter GetDataWriter() => !(this.Connection is BandConnection<BandSocketUWP> connection) ? (DataWriter) null : connection.Cargo.GetDataWriter();
  }
}
