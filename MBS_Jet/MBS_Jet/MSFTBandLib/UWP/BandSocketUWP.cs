...
namespace MobileBandSync.MSFTBandLib.UWP
{
  public class BandSocketUWP : BandSocketInterface, IDisposable
  {
    ...
    public async Task Connect(string mac, Guid uuid, Action<ulong, ulong> Progress = null)
    {
      ...
      BandSocketUWP.\u003C\u003Ec__DisplayClass13_0 cDisplayClass130 = new BandSocketUWP.\u003C\u003Ec__DisplayClass13_0();
      ...
      try
      {
        ...
        if (cDisplayClass130.Progress != null)
        {
          ...
          await CoreApplication.MainView.CoreWindow.Dispatcher.RunAsync((CoreDispatcherPriority) 0, new DispatchedHandler((object) cDisplayClass130, __methodptr(\u003CConnect\u003Eb__0)));
        }
      }
      catch (Exception ex)
      {
      ...
      RfcommDeviceService serviceForHostFromUuid = await BandSocketUWP.GetRfcommDeviceServiceForHostFromUuid(host, uuid);
      this.Socket = new StreamSocket();
      await this.Socket.ConnectAsync(host, serviceForHostFromUuid.ConnectionServiceName, (SocketProtectionLevel) 3);
      DataReader dataReader = new DataReader(this.Socket.InputStream);
      dataReader.put_InputStreamOptions((InputStreamOptions) 1);
      ...
      Action<ulong, ulong> Progress = null)
    {
      ...
      return await Task.Run<CommandResponse>((Func<Task<CommandResponse>>) (async () =>
      {
        // ISSUE: object of a compiler-generated type is created
        // ISSUE: variable of a compiler-generated type
        BandSocketUWP.\u003C\u003Ec__DisplayClass18_2 cDisplayClass182_1 = new BandSocketUWP.\u003C\u003Ec__DisplayClass18_2();
        // ISSUE: reference to a compiler-generated field
        ...
        while (true)
        {
          ...
          CommandResponse commandResponse = await Task.Run<CommandResponse>(new Func<Task<CommandResponse>>(cDisplayClass180.\u003CReceive\u003Eb__1));
          // ISSUE: reference to a compiler-generated field
          ...
          try
          {
            ...
            {
              // ISSUE: method pointer
              await CoreApplication.MainView.CoreWindow.Dispatcher.RunAsync((CoreDispatcherPriority) 0, new DispatchedHandler((object) cDisplayClass180, __methodptr(\u003CReceive\u003Eb__2)));
            }
          }
          catch (Exception ex)
          {
        ...
        // ISSUE: reference to a compiler-generated field
        return cDisplayClass182_1.response;
      }));
    }
