...
namespace MobileBandSync
{
  public sealed class ItemPage : Page, IComponentConnector
  {
    ...
    private async void NavigationHelper_LoadState(object sender, LoadStateEventArgs e) => this.DefaultViewModel["Item"] = (object) await WorkoutDataSource.GetItemAsync((string) e.NavigationParameter);
