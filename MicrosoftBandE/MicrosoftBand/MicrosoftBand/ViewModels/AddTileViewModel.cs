namespace MicrosoftBand.ViewModels
{
    ...
    public class AddTileViewModel : ViewModelBase
    {
        ...
        private Microsoft.Band.Portable.BandImage _tileIcon;
        private Microsoft.Band.Portable.BandImage _tileBadge;
        ...
        {
            get 
            { return _createTileCommand = _createTileCommand 
                    ?? new DelegateCommandAsync(CreateTileCommandExecute); 
            }
        }
        ...
        private async Task CreateTileCommandExecute()
        {
            try
            {
                ...
                // Tile Custom Layouts
                IEnumerable<PageLayout> layouts 
                    = CreatePageLayouts();
                tile.PageLayouts.AddRange(
                    (IEnumerable<Microsoft.Band.Portable.Tiles.Pages.PageLayout>)layouts);

                // Add Tile
                await _tileManager.AddTileAsync(tile);

                // Update with page data
                IEnumerable<PageData> datas = CreatePageDatas();
                await _tileManager.SetTilePageDataAsync(tile.Id, 
                    (IEnumerable<Microsoft.Band.Portable.Tiles.Pages.Data.PageData>)datas);
            }
            catch(Exception ex)
            {
        ...
        private static PageLayout[] CreatePageLayouts() => new[] {
                    ...
                    Root = new ScrollFlowPanel {
                        ...
                        Elements = {
                            ...
                            new TextBlock
                            {
                                ...
                                Color = new Microsoft.Band.BandColor(255, 0, 0),
                                AutoWidth = false,
                            ...
                            new FlowPanel {
                                ...
                                Elements = {
                                    new Icon {
                                        ...
                                        Color = new Microsoft.Band.BandColor(127, 127, 0),
                                    ...
                                    new Icon {
                                        ElementId = 22,
                                        Rect = new PageRect(0, 0, 100, 70),
                                        Color = new Microsoft.Band.BandColor(127, 0, 127),
                                        VerticalAlignment = VerticalAlignment.Center,
                                        HorizontalAlignment = HorizontalAlignment.Center
                                    }
                                }
                    ...
                    Root = new ScrollFlowPanel {
                        ...
                        Elements = {
                            ...
                            new TextButton {
                                ...
                                PressedColor = new Microsoft.Band.BandColor(0, 127, 0)
                            },
                            new TextBlock
                            {
                                ElementId = 33,
                            ...
                            new FilledButton {
                                ElementId = 34,
                                Rect = new PageRect(0, 0, 229, 43),
                                BackgroundColor = new Microsoft.Band.BandColor(0, 0, 127)
                            }
                        }
                    }
                }
        ...
        private static IEnumerable<PageData> CreatePageDatas()
        {
            return new[] 
            {
                ...
                new PageData(Guid.Empty,0,default) 
                {
                    PageId = Guid.NewGuid(),
                    PageLayoutIndex = 0,
                    /*Data = {
                ...
                new PageData(Guid.Empty,0, null) {
                    PageId = Guid.NewGuid(),
                    PageLayoutIndex = 1,
                    /*Data = {
                        new ImageData {
                ...
                new PageData(Guid.Empty,0, null) {
                    ...
                    /*Data = {
                        ...
                        new FilledButtonData {
                            ElementId = 34,
                            PressedColor = new Microsoft.Band.BandColor(0, 127, 127),
                        }
                    }
                    */
                }
