...
namespace Microsoft.Band.Tiles.Pages
{
  public abstract class PagePanel : PageElement
  {
      ...
      HashSet<PageElement> existingElements)
    {
      ...
      int countAndValidate = 36 + this.SerializedCustomByteCount;
      foreach (PageElement element in (IEnumerable<PageElement>) this.Elements)
      {
        ...
        countAndValidate += element.GetSerializedByteCountAndValidate(existingIDs, existingElements);
      }
      return countAndValidate;
    }
