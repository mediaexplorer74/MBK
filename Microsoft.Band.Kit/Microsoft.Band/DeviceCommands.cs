...
namespace Microsoft.Band
{
  public static class DeviceCommands
  {
    ...
    internal static ushort CargoRemoteSubscriptionGetDataLength = DeviceCommands.MakeCommand(Facility.LibraryRemoteSubscription, TX.True, (byte) 2);
        public static ushort CargoRemoteSubscriptionGetData = DeviceCommands.MakeCommand(Facility.LibraryRemoteSubscription, TX.True, (byte) 3);
    public static ushort CargoRemoteSubscriptionSubscribeId = DeviceCommands.MakeCommand(Facility.LibraryRemoteSubscription, TX.False, (byte) 7);
        public static ushort CargoRemoteSubscriptionUnsubscribeId = DeviceCommands.MakeCommand(Facility.LibraryRemoteSubscription, TX.False, (byte) 8);
        public static ushort CargoNotification = DeviceCommands.MakeCommand(Facility.ModuleNotification, TX.False, (byte) 0);
        public static ushort CargoNotificationProtoBuf = DeviceCommands.MakeCommand(Facility.ModuleNotification, TX.False, (byte) 5);
        public static ushort CargoDynamicAppRegisterApp = DeviceCommands.MakeCommand(Facility.ModuleFireballAppsManagement, TX.False, (byte) 0);
        public static ushort CargoDynamicAppRemoveApp = DeviceCommands.MakeCommand(Facility.ModuleFireballAppsManagement, TX.False, (byte) 1);
        public static ushort CargoDynamicAppRegisterAppIcons = DeviceCommands.MakeCommand(Facility.ModuleFireballAppsManagement, TX.False, (byte) 2);
        public static ushort CargoDynamicAppSetAppTileIndex = DeviceCommands.MakeCommand(Facility.ModuleFireballAppsManagement, TX.False, (byte) 3);
        public static ushort CargoDynamicAppSetAppBadgeTileIndex = DeviceCommands.MakeCommand(Facility.ModuleFireballAppsManagement, TX.False, (byte) 5);
        public static ushort CargoDynamicAppSetAppNotificationTileIndex = DeviceCommands.MakeCommand(Facility.ModuleFireballAppsManagement, TX.False, (byte) 11);
        public static ushort CargoDynamicPageLayoutSet = DeviceCommands.MakeCommand(Facility.ModuleFireballPageManagement, TX.False, (byte) 0);
        public static ushort CargoDynamicPageLayoutRemove = DeviceCommands.MakeCommand(Facility.ModuleFireballPageManagement, TX.False, (byte) 1);
    ...
    internal static ushort CargoPersistedAppDataDisableSleepNotification = DeviceCommands.MakeCommand(Facility.ModulePersistedApplicationData, TX.False, (byte) 19);
        public static ushort CargoPersistedAppDataSetLightExposureNotification = DeviceCommands.MakeCommand(Facility.ModulePersistedApplicationData, TX.False, (byte) 21);
        public static ushort CargoPersistedAppDataGetLightExposureNotification = DeviceCommands.MakeCommand(Facility.ModulePersistedApplicationData, TX.True, (byte) 22);
        public static ushort CargoPersistedAppDataDisableLightExposureNotification = DeviceCommands.MakeCommand(Facility.ModulePersistedApplicationData, TX.False, (byte) 23);
        public static ushort CargoGetProductSerialNumber = DeviceCommands.MakeCommand(Facility.LibraryConfiguration, TX.True, (byte) 8);
        public static ushort CargoKeyboardCmd = DeviceCommands.MakeCommand(Facility.LibraryKeyboard, TX.False, (byte) 0);
        public static ushort CargoSubscriptionLoggerSubscribe = DeviceCommands.MakeCommand(Facility.ModuleLoggerSubscriptions, TX.False, (byte) 0);
        public static ushort CargoSubscriptionLoggerUnsubscribe = DeviceCommands.MakeCommand(Facility.ModuleLoggerSubscriptions, TX.False, (byte) 1);
        public static ushort CargoCrashDumpGetFileSize = DeviceCommands.MakeCommand(Facility.DriverCrashDump, TX.True, (byte) 1);
        public static ushort CargoCrashDumpGetAndDeleteFile = DeviceCommands.MakeCommand(Facility.DriverCrashDump, TX.True, (byte) 2);
        public static ushort CargoInstrumentationGetFileSize = DeviceCommands.MakeCommand(Facility.ModuleInstrumentation, TX.True, (byte) 4);
        public static ushort CargoInstrumentationGetFile = DeviceCommands.MakeCommand(Facility.ModuleInstrumentation, TX.True, (byte) 5);
        public static ushort CargoPersistedStatisticsRunGet = DeviceCommands.MakeCommand(Facility.ModulePersistedStatistics, TX.True, (byte) 2);
        public static ushort CargoPersistedStatisticsWorkoutGet = DeviceCommands.MakeCommand(Facility.ModulePersistedStatistics, TX.True, (byte) 3);
        public static ushort CargoPersistedStatisticsSleepGet = DeviceCommands.MakeCommand(Facility.ModulePersistedStatistics, TX.True, (byte) 4);
        public static ushort CargoPersistedStatisticsGuidedWorkoutGet = DeviceCommands.MakeCommand(Facility.ModulePersistedStatistics, TX.True, (byte) 5);
