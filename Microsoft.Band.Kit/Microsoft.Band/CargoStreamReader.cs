...
namespace Microsoft.Band
{
  public sealed class CargoStreamReader : CargoStreamBase, ICargoReader, IDisposable
  {
    ...
    private int ReadToBuffer()
    {
      ...
      int buffer = this.stream.Read(this.buffer.Buffer, this.bufferedBytes, this.bufferPool.BufferSize - this.bufferedBytes);
      this.bufferedBytes += buffer;
      return buffer;
    }
    ...
    public bool ReadBool32()
    {
      this.CheckIfDisposed();
      this.ReadToBufferMinimum(4);
      int num = BitConverter.ToInt32(this.buffer.Buffer, this.bufferOffset) != 0 ? 1 : 0;
      this.AdvanceBuffer(4);
      return num != 0;
    }
